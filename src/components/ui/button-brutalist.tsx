...
export interface ButtonBrutalistProps
  extends React.ButtonHTMLAttributes<HTMLButtonElement>,
    VariantProps<typeof buttonVariants> {
  asChild?: boolean
}

const ButtonBrutalist = React.forwardRef<HTMLButtonElement, ButtonBrutalistProps>(
...
ButtonBrutalist.displayName = "ButtonBrutalist"

export { ButtonBrutalist, buttonVariants }
